...
*ProjectsApi* | [**getProject**](docs/Api/ProjectsApi.md#getproject) | **GET** /v1/projects/{projectId} | 
...
- [CorsGrantAccessVfsOK](docs/Model/CorsGrantAccessVfsOK.md)
- [CorsUpdateAccessVfsOK](docs/Model/CorsUpdateAccessVfsOK.md)
