...
class WellKnownApi
{
     ...
     * @return \AffinidiTdk\Clients\ConsumerIamClient\Model\JsonWebKeySetDto|\AffinidiTdk\Clients\ConsumerIamClient\Model\UnexpectedError
     */
     ...
     * @throws \AffinidiTdk\Clients\ConsumerIamClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AffinidiTdk\Clients\ConsumerIamClient\Model\JsonWebKeySetDto|\AffinidiTdk\Clients\ConsumerIamClient\Model\UnexpectedError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWellKnownJwksWithHttpInfo(string $contentType = self::contentTypes['getWellKnownJwks'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AffinidiTdk\Clients\ConsumerIamClient\Model\JsonWebKeySetDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AffinidiTdk\Clients\ConsumerIamClient\Model\JsonWebKeySetDto' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AffinidiTdk\Clients\ConsumerIamClient\Model\JsonWebKeySetDto', []),
            ...
            $returnType = '\AffinidiTdk\Clients\ConsumerIamClient\Model\JsonWebKeySetDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AffinidiTdk\Clients\ConsumerIamClient\Model\JsonWebKeySetDto',
