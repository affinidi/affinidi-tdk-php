...
class CredentialsApi
{
    ...
    /**
     * Operation batchCredential
     *
     * Allows wallets to claim multiple credentials at once.
     *
     * @param  string $project_id Affinidi project id (required)
     * @param  \AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialInput $batch_credential_input Request body for batch credential (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['batchCredential'] to see the possible values for this operation
     *
     ...
     * @return \AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialResponse
     */
    public function batchCredential($project_id, $batch_credential_input, string $contentType = self::contentTypes['batchCredential'][0])
    {
        list($response) = $this->batchCredentialWithHttpInfo($project_id, $batch_credential_input, $contentType);
        return $response;
    }

    /**
     * Operation batchCredentialWithHttpInfo
     *
     * Allows wallets to claim multiple credentials at once.
     *
     * @param  string $project_id Affinidi project id (required)
     ...
     * @throws \AffinidiTdk\Clients\CredentialIssuanceClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchCredentialWithHttpInfo($project_id, $batch_credential_input, string $contentType = self::contentTypes['batchCredential'][0])
    {
        $request = $this->batchCredentialRequest($project_id, $batch_credential_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialResponse', []),
            ...
            $returnType = '\AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialResponse',
    ...
    /**
     * Operation batchCredentialAsync
     *
     * Allows wallets to claim multiple credentials at once.
     *
     * @param  string $project_id Affinidi project id (required)
     ...
     */
    public function batchCredentialAsync($project_id, $batch_credential_input, string $contentType = self::contentTypes['batchCredential'][0])
    {
        return $this->batchCredentialAsyncWithHttpInfo($project_id, $batch_credential_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation batchCredentialAsyncWithHttpInfo
     *
     * Allows wallets to claim multiple credentials at once.
     *
     * @param  string $project_id Affinidi project id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchCredentialAsyncWithHttpInfo($project_id, $batch_credential_input, string $contentType = self::contentTypes['batchCredential'][0])
    {
        $returnType = '\AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialResponse';
        $request = $this->batchCredentialRequest($project_id, $batch_credential_input, $contentType);
    ...
    /**
     * Create request for operation 'batchCredential'
     *
     * @param  string $project_id Affinidi project id (required)
     * @param  \AffinidiTdk\Clients\CredentialIssuanceClient\Model\BatchCredentialInput $batch_credential_input Request body for batch credential (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['batchCredential'] to see the possible values for this operation
     ...
     */
    public function batchCredentialRequest($project_id, $batch_credential_input, string $contentType = self::contentTypes['batchCredential'][0])
    {

        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling batchCredential'
            );
        }

        // verify the required parameter 'batch_credential_input' is set
        if ($batch_credential_input === null || (is_array($batch_credential_input) && count($batch_credential_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $batch_credential_input when calling batchCredential'
            );
        }


        $resourcePath = '/v1/{projectId}/batch_credential';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($batch_credential_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($batch_credential_input));
            } else {
                $httpBody = $batch_credential_input;
            }
     ...
     */
    public function getClaimedCredentials($project_id, $configuration_id, $range_start_time, $range_end_time = null, $exclusive_start_key = null, $limit = 20, string $contentType = self::contentTypes['getClaimedCredentials'][0])
    {
        list($response) = $this->getClaimedCredentialsWithHttpInfo($project_id, $configuration_id, $range_start_time, $range_end_time, $exclusive_start_key, $limit, $contentType);
        return $response;
    }
     ...
     */
    public function getClaimedCredentialsWithHttpInfo($project_id, $configuration_id, $range_start_time, $range_end_time = null, $exclusive_start_key = null, $limit = 20, string $contentType = self::contentTypes['getClaimedCredentials'][0])
    {
        $request = $this->getClaimedCredentialsRequest($project_id, $configuration_id, $range_start_time, $range_end_time, $exclusive_start_key, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClaimedCredentialsAsync($project_id, $configuration_id, $range_start_time, $range_end_time = null, $exclusive_start_key = null, $limit = 20, string $contentType = self::contentTypes['getClaimedCredentials'][0])
    {
        return $this->getClaimedCredentialsAsyncWithHttpInfo($project_id, $configuration_id, $range_start_time, $range_end_time, $exclusive_start_key, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClaimedCredentialsAsyncWithHttpInfo($project_id, $configuration_id, $range_start_time, $range_end_time = null, $exclusive_start_key = null, $limit = 20, string $contentType = self::contentTypes['getClaimedCredentials'][0])
    {
        $returnType = '\AffinidiTdk\Clients\CredentialIssuanceClient\Model\ClaimedCredentialListResponse';
        $request = $this->getClaimedCredentialsRequest($project_id, $configuration_id, $range_start_time, $range_end_time, $exclusive_start_key, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getClaimedCredentialsRequest($project_id, $configuration_id, $range_start_time, $range_end_time = null, $exclusive_start_key = null, $limit = 20, string $contentType = self::contentTypes['getClaimedCredentials'][0])
    {
        ...
        if ($exclusive_start_key !== null && strlen($exclusive_start_key) > 3000) {
            throw new \InvalidArgumentException('invalid length for "$exclusive_start_key" when calling CredentialsApi.getClaimedCredentials, must be smaller than or equal to 3000.');
        }
        
        if ($limit !== null && $limit > 20) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling CredentialsApi.getClaimedCredentials, must be smaller than or equal to 20.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling CredentialsApi.getClaimedCredentials, must be bigger than or equal to 1.');
        }
