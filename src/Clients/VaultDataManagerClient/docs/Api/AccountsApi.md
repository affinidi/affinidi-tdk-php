...
```php
listProfiles(): \AffinidiTdk\Clients\VaultDataManagerClient\Model\ListProfilesOK
```
...
try {
    ...
    echo 'Exception when calling AccountsApi->listProfiles: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\AffinidiTdk\Clients\VaultDataManagerClient\Model\ListProfilesOK**](../Model/ListProfilesOK.md)
...
```php
patchAccount($account_index, $patch_account_input): \AffinidiTdk\Clients\VaultDataManagerClient\Model\UpdateAccountDto
```
...
$account_index = 56; // int
$patch_account_input = new \AffinidiTdk\Clients\VaultDataManagerClient\Model\PatchAccountInput(); // \AffinidiTdk\Clients\VaultDataManagerClient\Model\PatchAccountInput | PatchAccount

try {
    $result = $apiInstance->patchAccount($account_index, $patch_account_input);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AccountsApi->patchAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **account_index** | **int**|  | |
| **patch_account_input** | [**\AffinidiTdk\Clients\VaultDataManagerClient\Model\PatchAccountInput**](../Model/PatchAccountInput.md)| PatchAccount | |

### Return type

[**\AffinidiTdk\Clients\VaultDataManagerClient\Model\UpdateAccountDto**](../Model/UpdateAccountDto.md)
...
```php
updateAccount($account_index, $update_account_input): \AffinidiTdk\Clients\VaultDataManagerClient\Model\UpdateAccountDto
```
...
$account_index = 56; // int
$update_account_input = new \AffinidiTdk\Clients\VaultDataManagerClient\Model\UpdateAccountInput(); // \AffinidiTdk\Clients\VaultDataManagerClient\Model\UpdateAccountInput | UpdateAccount

try {
    $result = $apiInstance->updateAccount($account_index, $update_account_input);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **account_index** | **int**|  | |
| **update_account_input** | [**\AffinidiTdk\Clients\VaultDataManagerClient\Model\UpdateAccountInput**](../Model/UpdateAccountInput.md)| UpdateAccount | |
