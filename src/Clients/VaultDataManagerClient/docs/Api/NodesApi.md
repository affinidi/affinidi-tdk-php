...
```php
getDetailedNodeInfo($node_id, $dek): \AffinidiTdk\Clients\VaultDataManagerClient\Model\GetDetailedNodeInfoOK
```
...
try {
    $result = $apiInstance->getDetailedNodeInfo($node_id, $dek);
    print_r($result);
} catch (Exception $e) {
...
```php
listNodeChildren($node_id, $limit, $exclusive_start_key): \AffinidiTdk\Clients\VaultDataManagerClient\Model\ListNodeChildrenOK
```
...
try {
    $result = $apiInstance->listNodeChildren($node_id, $limit, $exclusive_start_key);
    print_r($result);
} catch (Exception $e) {
...
```php
listRootNodeChildren(): \AffinidiTdk\Clients\VaultDataManagerClient\Model\ListRootNodeChildrenOK
```
...
try {
    $result = $apiInstance->listRootNodeChildren();
    print_r($result);
} catch (Exception $e) {
