...
class GrantAccessInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^did:.*$/", $this->container['subject_did'])) {
            $invalidProperties[] = "invalid value for 'subject_did', must be conform to the pattern /^did:.*$/.";
        }
     ...
     * Sets subject_did
     *
     * @param string $subject_did DID of the consumer to share Nodes hierarchy with
     *
     * @return self
     */
    public function setSubjectDid($subject_did)
    {
        ...
        if ((!preg_match("/^did:.*$/", ObjectSerializer::toString($subject_did)))) {
            throw new \InvalidArgumentException("invalid value for \$subject_did when calling GrantAccessInput., must conform to the pattern /^did:.*$/.");
        }
     ...
     * Sets rights
     *
     * @param string[] $rights types of access to grant
     *
     * @return self
     */
