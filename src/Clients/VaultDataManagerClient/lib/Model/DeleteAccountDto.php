...
/**
 * DeleteAccountDto Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\VaultDataManagerClient
 * @author   OpenAPI Generator team
 ...
 */
class DeleteAccountDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteAccountDto';
    ...
    */
     ...
     * Sets account_index
     *
     * @param float|null $account_index account_index
     *
     * @return self
     */
