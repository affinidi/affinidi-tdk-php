...
class AccountDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets profile_did
     *
     * @param string $profile_did Profile DID that is associated with the account number
     *
     * @return self
     */
    public function setProfileDid($profile_did)
    {
        ...
        if ((!preg_match("/^did:.*$/", ObjectSerializer::toString($profile_did)))) {
            throw new \InvalidArgumentException("invalid value for \$profile_did when calling AccountDto., must conform to the pattern /^did:.*$/.");
        }
