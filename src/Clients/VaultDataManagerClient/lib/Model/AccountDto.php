...
class AccountDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['did']) && !preg_match("/^did:.*$/", $this->container['did'])) {
            $invalidProperties[] = "invalid value for 'did', must be conform to the pattern /^did:.*$/.";
        }
     ...
     * Sets did
     *
     * @param string|null $did Profile DID
     *
     * @return self
     */
    public function setDid($did)
    {
        ...
        if ((!preg_match("/^did:.*$/", ObjectSerializer::toString($did)))) {
            throw new \InvalidArgumentException("invalid value for \$did when calling AccountDto., must conform to the pattern /^did:.*$/.");
        }
