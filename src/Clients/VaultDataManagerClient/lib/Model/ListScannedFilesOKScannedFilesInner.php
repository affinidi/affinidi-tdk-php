...
/**
 * ListScannedFilesOKScannedFilesInner Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\VaultDataManagerClient
 * @author   OpenAPI Generator team
 ...
 */
class ListScannedFilesOKScannedFilesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListScannedFilesOK_scannedFiles_inner';
    ...
    */
     ...
     * Sets job_id
     *
     * @param string $job_id A unique, randomly generated identifier
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The Status of the listed files
     *
     * @return self
     */
