...
class ConsumerMetadataDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_by
     *
     * @param string $created_by [GEN] Identifier of the user who created the entity
     *
     * @return self
     */
     ...
     * Sets modified_by
     *
     * @param string $modified_by [GEN] Identifier of the user who last updated the entity
     *
     * @return self
     */
