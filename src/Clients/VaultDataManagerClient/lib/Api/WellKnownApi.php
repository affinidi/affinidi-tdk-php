...
class WellKnownApi
{
     ...
     * @return \AffinidiTdk\Clients\VaultDataManagerClient\Model\JsonWebKeySetDto|\AffinidiTdk\Clients\VaultDataManagerClient\Model\InvalidParameterError|\AffinidiTdk\Clients\VaultDataManagerClient\Model\UnexpectedError
     */
     ...
     * @throws \AffinidiTdk\Clients\VaultDataManagerClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AffinidiTdk\Clients\VaultDataManagerClient\Model\JsonWebKeySetDto|\AffinidiTdk\Clients\VaultDataManagerClient\Model\InvalidParameterError|\AffinidiTdk\Clients\VaultDataManagerClient\Model\UnexpectedError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWellKnownJwksWithHttpInfo(string $contentType = self::contentTypes['getWellKnownJwks'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AffinidiTdk\Clients\VaultDataManagerClient\Model\JsonWebKeySetDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AffinidiTdk\Clients\VaultDataManagerClient\Model\JsonWebKeySetDto' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AffinidiTdk\Clients\VaultDataManagerClient\Model\JsonWebKeySetDto', []),
                ...
                case 500:
                    if ('\AffinidiTdk\Clients\VaultDataManagerClient\Model\UnexpectedError' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AffinidiTdk\Clients\VaultDataManagerClient\Model\UnexpectedError' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AffinidiTdk\Clients\VaultDataManagerClient\Model\UnexpectedError', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\AffinidiTdk\Clients\VaultDataManagerClient\Model\JsonWebKeySetDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AffinidiTdk\Clients\VaultDataManagerClient\Model\JsonWebKeySetDto',
                ...
                case 500:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AffinidiTdk\Clients\VaultDataManagerClient\Model\UnexpectedError',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
