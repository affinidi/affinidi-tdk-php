...
```php
signJwtV2($wallet_id, $sign_jwt_v2): \AffinidiTdk\Clients\WalletsClient\Model\SignJwtV2OK
```
...
$wallet_id = 'wallet_id_example'; // string | id of the wallet
$sign_jwt_v2 = new \AffinidiTdk\Clients\WalletsClient\Model\SignJwtV2(); // \AffinidiTdk\Clients\WalletsClient\Model\SignJwtV2 | SignJwtV2

try {
    $result = $apiInstance->signJwtV2($wallet_id, $sign_jwt_v2);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **wallet_id** | **string**| id of the wallet | |
| **sign_jwt_v2** | [**\AffinidiTdk\Clients\WalletsClient\Model\SignJwtV2**](../Model/SignJwtV2.md)| SignJwtV2 | |

### Return type

[**\AffinidiTdk\Clients\WalletsClient\Model\SignJwtV2OK**](../Model/SignJwtV2OK.md)
