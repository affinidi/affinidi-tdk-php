...
/**
 * UpdateDcqlQueryInput Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\IotaClient
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDcqlQueryInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDcqlQueryInput';
    ...
    */
     ...
     * Sets dcql_query
     *
     * @param string|null $dcql_query The DCQL query describing the data requirement that must be satisfied by the user. The value is in a JSON stringify format.
     *
     * @return self
     */
