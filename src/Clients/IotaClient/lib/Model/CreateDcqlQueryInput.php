...
/**
 * CreateDcqlQueryInput Class Doc Comment
 *
 * @category Class
 * @package  AffinidiTdk\Clients\IotaClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateDcqlQueryInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDcqlQueryInput';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The name of the DCQL query to quickly identify the query.
     *
     * @return self
     */
     ...
     * Sets dcql_query
     *
     * @param string $dcql_query The DCQL query describing the data requirement that must be satisfied by the user. The value is in a JSON stringify format.
     *
     * @return self
     */
