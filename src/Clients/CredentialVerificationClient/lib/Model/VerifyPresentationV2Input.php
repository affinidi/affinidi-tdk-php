...
class VerifyPresentationV2Input implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets challenge
     *
     * @param string|null $challenge Optional challenge string for domain/challenge verification
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string[]|null $domain Optional domain for verification. Array of domain strings as per W3C VP standard
     *
     * @return self
     */
