...
namespace AffinidiTdk\Clients\CredentialVerificationClient;

use GuzzleHttp\Psr7\Utils;
use AffinidiTdk\Clients\CredentialVerificationClient\Model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\AffinidiTdk\Clients\CredentialVerificationClient\Model\\' . $data->{$discriminator};
